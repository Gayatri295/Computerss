...
public static void main(String []args) {
	...
	cp.mb.id=123;
	cp.mb.qualityRating=2;
	cp.mb.warrentyPeriod=5;
	//mother board bill
	cp.mb.bill=new Bill();
	cp.mb.bill.billNo=1111;
	cp.mb.bill.basePrice=2556;
	cp.mb.bill.centralTax=2598;
	cp.mb.bill.centralTax=4589;
	cp.mb.bill.serviceTax=78;
	cp.mb.bill.stateTax=865;
